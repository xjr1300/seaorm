...
しかしながら、自動的に強固になならない。
エラハンドリングに注意していなければ、プログラムは予期せずパニックする。

プログラムがパニックしなくても、正しいことを意味していない。
プログラムは誤った振る舞いを行い、混沌としたデータを作成する。
...
ドメインレベルな基本的な全体プログラムのテストで、生成したデータと一般的なユーザーの操作を提供することを要求する。
